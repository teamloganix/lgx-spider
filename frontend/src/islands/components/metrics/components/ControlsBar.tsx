...
import { Settings2, Filter, Search, X, Pause, Play } from 'lucide-react';
import { getDefaultMetricsColumns } from '../utils/config';
      ...
      <div className="flex flex-wrap items-center gap-2 flex-1 min-w-0">
        ...
        {onPauseResume && (
          <Button
            ...
            size="sm"
            className={paused ? 'bg-green-600 hover:bg-green-700 shrink-0' : 'shrink-0'}
        ...
        {onBlacklistProcessed && (
          <Button
            ...
            onClick={onBlacklistProcessed}
            disabled={blacklistLoading}
          >
            {blacklistLoading ? (
              <span className="animate-pulse">Blacklisting...</span>
            ) : (
              <>
